...
class SessionRate(models.Model):
    score = models.IntegerField(min=0, max=5, null=False, blank=False)
    student = models.ForeignKey(
        Student, on_delete=models.CASCADE, related_name="user_rate_on_session")
...
class SessionFeedback(models.Model):
    ...
    student = models.ForeignKey(
        Student, on_delete=models.CASCADE, related_name="user feedback")
